...
unsigned char songName[16][30] = {
"1: fate",
"2: Shock Me into Love",
"3: lonely northen earth",
"4: most important dicision",
  ...
  MSDelay(1);
   ...
   while(1){                              //OPEN WHILE(1)
      ...
      if(row == 0x10){
         ...
         for(i=0;songName[4+column][i]!='\0'; ++i) {
         ...
         for(i=0;songName[8+column][i]!='\0'; ++i) {
         
            DATWRT4(songName[8+column][i]);
            MSDelay(1);
         }
         ...
         for(i=0;songName[12+column][i]!='\0'; ++i) {
         
            DATWRT4(songName[12+column][i]);
            MSDelay(1);
         }
